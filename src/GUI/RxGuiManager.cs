...
namespace RxInputManager.Gui
{
      ...
      IGameComponent, IUpdateable, IDrawable, IDisposable, IGuiService
    {
        ...
        /// </param>
        public RxGuiManager(GameServiceContainer gameServices)
        {
        ...
        public void Initialize()
        {
            ...
            // We only require an IRxInputService if the user doesn't use a custom input
            ...
            if (this.inputCapturer == null)
            {
                ...
                this.inputCapturer = new RxDefaultInputCapturer(this.inputService);
            ...
            if (this.guiVisualizer == null)
            {
                ...
                Visualizer = Nuclex.UserInterface.Visuals.Flat.FlatGuiVisualizer.FromResource(
                  services, ChairWars.Resources.SuaveSkinResources.ResourceManager, "SuaveSkin"
                );

               // Visualizer = Visuals.Flat.FlatGuiVisualizer.FromFile(services, @"Resources\Skins\Suave\Suave.skin.xml");
        ...
        /// </remarks>
        public Nuclex.UserInterface.Input.IInputCapturer InputCapturer
        {
        ...
        ///   your own.
        /// </remarks>
        public Nuclex.UserInterface.Visuals.IGuiVisualizer Visualizer
        {
        ...
        private static IRxInputService getInputService(IServiceProvider serviceProvider)
        {
            ...
            if (inputService == null)
            {
                throw new InvalidOperationException(
                  "Using the GUI with the default input capturer requires the IRxInputService. " +
                  "Please either add the IRxInputService to Game.Services by using the " +
        ...
        private Nuclex.UserInterface.Input.IInputCapturer inputCapturer;
        /// <summary>
        ///   The IInputCapturer under its IUpdateable interface, if implemented
        /// </summary>
        private IUpdateable updateableInputCapturer;
        /// <summary>Draws the GUI</summary>
        private Nuclex.UserInterface.Visuals.IGuiVisualizer guiVisualizer;
        /// <summary>
